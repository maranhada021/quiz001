function checkAnswers() {
    let answers = ["Groundwater","Approximately 70%","2 liters","Taking a shower","50-60%"];
    let correctCount = 0;
...
function displayResults(correctCount, incorrectQuestions) {
    ...
    if (incorrectQuestions.length === 0) {
        ...
        resultsDiv.textContent = "Você acertou " + correctCount + " de 5 perguntas e errou nas perguntas: " + incorrectQuestions.join(", ");
    }
}